...
class Config:
    ...
    def validate(self):
        ...
        required_fields = ['confluence_url', 'confluence_username',
                           'confluence_password', 'confluence_parent_page_id',
        ...
        if not (getattr(self, 'confluence_space_key') or
                getattr(self, 'confluence_space_id')):
            missing_fields.append(
                'confluence_space_key or confluence_space_id')
